 ...
 */
export function ownerUsesIntenseCloudSync(ownerData) {
 ...
 * attempted device ended as `ok` or `empty`. Any `error` (or no targets) must
 * leave the flag false so the next cron retry can still recover data.
 */
export function shouldMarkIntenseEventUploaded(deviceResults) {
