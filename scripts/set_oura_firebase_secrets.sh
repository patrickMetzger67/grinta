...
echo "Next:"
echo "  firebase deploy --only functions:ouraOAuthStart,functions:ouraOAuthCallback,functions:ouraDisconnect,functions:ouraRepairPlayerSync,functions:ouraListActivities,functions:ouraImportActivity"
echo
