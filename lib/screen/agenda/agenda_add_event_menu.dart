...
Future<void> _handleSelection(
  ...
  if (kind == AgendaAddEventKind.playerTask) {
        ...
        children: [
          ...
          if (context.watch<AppSession>().hasManagedTeamsInSelectedSeason) ...[
            ...
            _AgendaAddEventOptionTile(
              ...
              iconColor: colors.primary,
              title: l10n.agendaAddEventPlayerTask,
              subtitle: l10n.agendaAddEventPlayerTaskHint,
              onTap: () => onSelected(AgendaAddEventKind.playerTask),
            ),
          ],
        ],
      ),
