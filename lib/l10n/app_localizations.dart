...
abstract class AppLocalizations {
  ...
  /// No description provided for @coachWorkloadMetricMatches.
  ///
  /// In fr, this message translates to:
  /// **'{count} matchs'**
  ...
  String get adminUsersPasswordResetTooltip;

  /// No description provided for @adminUsersPasswordResetConfirmTitle.
  ///
  /// In fr, this message translates to:
  /// **'Renouveler le mot de passe ?'**
  String get adminUsersPasswordResetConfirmTitle;

  /// No description provided for @adminUsersPasswordResetConfirmMessage.
  ///
  /// In fr, this message translates to:
  /// **'Un e-mail de réinitialisation sera envoyé à {email}.'**
  String adminUsersPasswordResetConfirmMessage(String email);

  /// No description provided for @adminUsersPasswordResetConfirmAction.
  ///
  /// In fr, this message translates to:
  /// **'Envoyer'**
  String get adminUsersPasswordResetConfirmAction;

  /// No description provided for @adminUsersPasswordResetSent.
  ///
  /// In fr, this message translates to:
  /// **'E-mail de réinitialisation envoyé.'**
  String get adminUsersPasswordResetSent;

  /// No description provided for @adminUsersPasswordResetNoEmail.
  ///
  /// In fr, this message translates to:
  /// **'Cet utilisateur n\'a pas d\'adresse e-mail.'**
  String get adminUsersPasswordResetNoEmail;

  /// No description provided for @adminUsersPasswordResetInvalidEmail.
  ///
  /// In fr, this message translates to:
  /// **'Adresse e-mail invalide.'**
  String get adminUsersPasswordResetInvalidEmail;

  /// No description provided for @adminUsersPasswordResetUserNotFound.
  ///
  /// In fr, this message translates to:
  /// **'Aucun compte Auth trouvé pour cet e-mail.'**
  String get adminUsersPasswordResetUserNotFound;

  /// No description provided for @adminUsersPasswordResetFailed.
  ///
  /// In fr, this message translates to:
  /// **'Impossible d\'envoyer l\'e-mail de réinitialisation.'**
  String get adminUsersPasswordResetFailed;

  /// No description provided for @adminPlayersSection.
  ///
  /// In fr, this message translates to:
  /// **'Joueurs'**
  String get adminPlayersSection;

  /// No description provided for @adminPlayersSectionDesc.
  ///
  /// In fr, this message translates to:
  /// **'Lister les joueurs, consulter et associer des utilisateurs.'**
  String get adminPlayersSectionDesc;

  /// No description provided for @adminPlayersTitle.
  ///
  /// In fr, this message translates to:
  /// **'Joueurs'**
  String get adminPlayersTitle;

  /// No description provided for @adminPlayersSearchHint.
  ///
  /// In fr, this message translates to:
  /// **'Rechercher (prénom, nom, email)'**
  String get adminPlayersSearchHint;

  /// No description provided for @adminPlayersLoadError.
  ///
  /// In fr, this message translates to:
  /// **'Impossible de charger les joueurs.'**
  String get adminPlayersLoadError;

  /// No description provided for @adminPlayersEmpty.
  ///
  /// In fr, this message translates to:
  /// **'Aucun joueur pour le moment.'**
  String get adminPlayersEmpty;

  /// No description provided for @adminPlayersSearchEmpty.
  ///
  /// In fr, this message translates to:
  /// **'Aucun joueur ne correspond à la recherche.'**
  String get adminPlayersSearchEmpty;

  /// No description provided for @adminPlayersUserCount.
  ///
  /// In fr, this message translates to:
  ...
  /// No description provided for @adminPlayersUsersEmpty.
  ///
  /// In fr, this message translates to:
  /// **'Aucun utilisateur associé à ce joueur.'**
  String get adminPlayersUsersEmpty;

  /// No description provided for @adminPlayersAddUserFab.
  ///
  /// In fr, this message translates to:
  /// **'Ajouter un utilisateur'**
  String get adminPlayersAddUserFab;

  /// No description provided for @adminPlayersAddUserTitle.
  ///
  /// In fr, this message translates to:
  /// **'Ajouter un utilisateur'**
  String get adminPlayersAddUserTitle;

  /// No description provided for @adminPlayersAssociateSuccess.
  ///
  /// In fr, this message translates to:
  /// **'Utilisateur associé.'**
  String get adminPlayersAssociateSuccess;

  /// No description provided for @adminPlayersAssociateFailed.
  ///
  /// In fr, this message translates to:
  ...
  /// No description provided for @adminPolarBleScanTitle.
  ///
  /// In fr, this message translates to:
  /// **'Scanner les capteurs Polar'**
  String get adminPolarBleScanTitle;

  /// No description provided for @adminPolarBleScanSheetSubtitle.
  ///
  /// In fr, this message translates to:
  /// **'Lister les Polar à proximité et se connecter un par un'**
  String get adminPolarBleScanSheetSubtitle;

  /// No description provided for @adminPolarBleScanHint.
  ///
  /// In fr, this message translates to:
  ...
  /// No description provided for @adminPolarBleScanSearching.
  ///
  /// In fr, this message translates to:
  /// **'Recherche de capteurs Polar…'**
  String get adminPolarBleScanSearching;

  /// No description provided for @adminPolarBleScanEmpty.
  ///
  /// In fr, this message translates to:
  /// **'Aucun capteur Polar trouvé. Vérifie le Bluetooth et que les capteurs sont allumés.'**
  String get adminPolarBleScanEmpty;

  /// No description provided for @adminPolarBleScanUnsupported.
  ///
  /// In fr, this message translates to:
  /// **'Le scan Polar BLE est disponible uniquement sur iOS et Android.'**
  String get adminPolarBleScanUnsupported;

  /// No description provided for @adminPolarBleScanConnect.
  ///
  /// In fr, this message translates to:
  /// **'Connecter'**
  String get adminPolarBleScanConnect;

  /// No description provided for @adminPolarBleScanConnecting.
  ///
  /// In fr, this message translates to:
  /// **'Connexion…'**
  String get adminPolarBleScanConnecting;

  /// No description provided for @adminPolarBleScanConnected.
  ///
  /// In fr, this message translates to:
  /// **'Connecté'**
  String get adminPolarBleScanConnected;

  /// No description provided for @adminPolarBleScanAddToKit.
  ///
  /// In fr, this message translates to:
  /// **'Ajouter au kit'**
  String get adminPolarBleScanAddToKit;

  /// No description provided for @adminPolarBleScanStop.
  ///
  /// In fr, this message translates to:
  /// **'Arrêter le scan'**
  String get adminPolarBleScanStop;

  /// No description provided for @adminPolarBleScanRestart.
  ///
  /// In fr, this message translates to:
  /// **'Relancer le scan'**
  String get adminPolarBleScanRestart;

  /// No description provided for @adminPolarBleScanConnectError.
  ///
  /// In fr, this message translates to:
  /// **'Échec de connexion : {error}'**
  String adminPolarBleScanConnectError(String error);

  /// No description provided for @polarImportTitle.
  ///
  /// In fr, this message translates to:
  /// **'Import Polar (cardio)'**
  String get polarImportTitle;

  /// No description provided for @polarImportSensorsHeader.
  ///
  /// In fr, this message translates to:
  /// **'Capteurs Polar de la séance'**
  String get polarImportSensorsHeader;
  ...
  /// No description provided for @polarImportStatusPending.
  ///
  /// In fr, this message translates to:
  /// **'À importer'**
  String get polarImportStatusPending;

  /// No description provided for @polarImportStatusDone.
  ///
  /// In fr, this message translates to:
  /// **'Importé'**
  String get polarImportStatusDone;

  /// No description provided for @polarImportUntitledPlayer.
  ///
  /// In fr, this message translates to:
  /// **'Joueur'**
  String get polarImportUntitledPlayer;

  /// No description provided for @polarImportDeviceLine.
  ///
  /// In fr, this message translates to:
  ...
  ///
  /// In fr, this message translates to:
  /// **'Importer via Bluetooth'**
  String get polarImportBleAction;

  /// No description provided for @polarImportBleUnavailable.
  ///
  /// In fr, this message translates to:
  ...
  /// No description provided for @polarImportManualAction.
  ///
  /// In fr, this message translates to:
  /// **'Saisie manuelle'**
  String get polarImportManualAction;

  /// No description provided for @polarImportManualTitle.
  ///
  /// In fr, this message translates to:
  /// **'Saisie cardio Polar'**
  String get polarImportManualTitle;

  /// No description provided for @polarImportManualSubtitle.
  ///
  /// In fr, this message translates to:
  /// **'Renseigne la durée et la FC (calories / pas optionnels pour Loop).'**
  String get polarImportManualSubtitle;

  /// No description provided for @polarImportFieldDurationMin.
  ///
  /// In fr, this message translates to:
  /// **'Durée (minutes)'**
  String get polarImportFieldDurationMin;

  /// No description provided for @polarImportFieldAvgHr.
  ///
  /// In fr, this message translates to:
  /// **'FC moyenne (bpm)'**
  String get polarImportFieldAvgHr;

  /// No description provided for @polarImportFieldMaxHr.
  ///
  /// In fr, this message translates to:
  /// **'FC max (bpm)'**
  String get polarImportFieldMaxHr;

  /// No description provided for @polarImportFieldMinHr.
  ///
  /// In fr, this message translates to:
  /// **'FC min (bpm)'**
  String get polarImportFieldMinHr;

  /// No description provided for @polarImportFieldCalories.
  ///
  /// In fr, this message translates to:
  /// **'Calories (kcal, optionnel)'**
  String get polarImportFieldCalories;

  /// No description provided for @polarImportFieldDistanceM.
  ///
  /// In fr, this message translates to:
  /// **'Distance (m, optionnel)'**
  String get polarImportFieldDistanceM;

  /// No description provided for @polarImportFieldSteps.
  ///
  /// In fr, this message translates to:
  /// **'Pas (optionnel)'**
  String get polarImportFieldSteps;

  /// No description provided for @polarImportMissingPlayer.
  ///
  /// In fr, this message translates to:
  /// **'Aucun joueur associé à ce capteur.'**
  String get polarImportMissingPlayer;

  /// No description provided for @polarImportSuccess.
  ///
  /// In fr, this message translates to:
  ...
  /// In fr, this message translates to:
  /// **'Analyse adversaire'**
  String get opponentAnalysisPromptTitle;

  /// No description provided for @opponentAnalysisPromptMessage.
  ///
  /// In fr, this message translates to:
  ...
  /// In fr, this message translates to:
  /// **'Oui'**
  String get opponentAnalysisPromptYes;

  /// No description provided for @opponentAnalysisPromptRemindTomorrow.
  ///
  /// In fr, this message translates to:
  /// **'Me le rappeler demain'**
  String get opponentAnalysisPromptRemindTomorrow;

  /// No description provided for @opponentAnalysisPromptSkip.
  ///
  /// In fr, this message translates to:
  /// **'Passer'**
  String get opponentAnalysisPromptSkip;

  /// No description provided for @opponentAnalysisReportTitle.
  ///
  /// In fr, this message translates to:
  /// **'Rapport d’analyse adversaire'**
  String get opponentAnalysisReportTitle;

  /// No description provided for @opponentAnalysisReportOpponentLabel.
  ///
  /// In fr, this message translates to:
  /// **'Adversaire'**
  String get opponentAnalysisReportOpponentLabel;

  /// No description provided for @opponentAnalysisReportEmailIntro.
  ///
  /// In fr, this message translates to:
  /// **'Voici le rapport d’analyse de {opponentName} pour ton match du {kickoff}.'**
  ...
  /// No description provided for @opponentAnalysisReportEmailDialogMessage.
  ///
  /// In fr, this message translates to:
  /// **'Le rapport d’analyse de {opponentName} sera envoyé aux adresses ci-dessous.'**
  String opponentAnalysisReportEmailDialogMessage(String opponentName);

  /// No description provided for @opponentAnalysisReportEmailRecipientsLabel.
  ///
  /// In fr, this message translates to:
  /// **'Destinataires'**
  String get opponentAnalysisReportEmailRecipientsLabel;

  /// No description provided for @opponentAnalysisReportSendFailed.
  ///
  /// In fr, this message translates to:
